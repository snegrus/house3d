...
const structuralPillars = [
  ...
  { id: "p3", name: "p3", x: 1385, y: 335, height: 360 },
  ...
  { id: "p8", name: "p8", x: 1385, y: 700, height: 360 },
  ...
  { id: "p13", name: "p13", x: 1385, y: 930, height: 360 },
  { id: "p14", name: "p14", x: 995, y: 930, height: 360 },
  { id: "p15", name: "p15", x: 1385, y: 1215, height: 360 },
  { id: "p16", name: "p16", x: 995, y: 1215, height: 360 },
  { id: "p17", name: "p17", x: 755, y: 1215, height: 360 },
  { id: "p18", name: "p18", x: 1385, y: 1580, height: 360 },
...
function normalizeGroundFloor(floor: Floor) {
  ...
  const pillarObjects = new Map(floor.objects.map((object) => [object.id, object]));
